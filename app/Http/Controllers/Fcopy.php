...
class FbController extends Controller
{
         ...
         //loop through the competition and get each table
             ...
             do{
                 ...
                 try{
                     //get table from API
                     $datum = $returner($arg);
                    //  $datum = Football::getLeagueStandings($competition->id);
   ...
   function getLeagueTeams(){
    ...
    private function getTodayMatches(){
        ...
        //     try{
        //         //get today matches
        //     $datum = Football::getMatches(['competitions' => '', 'dateFrom' => $this->todayDate, 'dateTo' => $this->todayDate])->toArray();
    ...
    function getMatche(Request $request){
        ...
        // $datum = Football::getMatche(271412);
        $datum = Football::getMatches(['competitions' => '2021', 'dateFrom' => '2020-02-08', 'dateTo' => '2020-02-08',]);
       dd($datum[0]);
    ...
    function testStuffs(){
        ...
        // $datum = $this->updateBringer(function(){
        //     return Football::getLeagueStandings(2);
        // });
